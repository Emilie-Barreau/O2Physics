...
struct dileptonReader {
  ...
  void process(MyEventsSelected::iterator const& event, soa::Join<aod::ReducedMuons, aod::ReducedMuonsExtra, aod::ReducedMuonsLabels> const& muons, aod::ReducedMCTracks const& mctracks)
  {
