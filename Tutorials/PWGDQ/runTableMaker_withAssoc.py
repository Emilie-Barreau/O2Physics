...
parser.add_argument("--add_timestamp", help = "Add timestamp", action = "store_true")
parser.add_argument("--add_trackselec", help = "Add timestamp", action = "store_true")
...
barrelDeps = ["o2-analysis-trackselection", "o2-analysis-trackextension","o2-analysis-pid-tof-base", "o2-analysis-pid-tof", "o2-analysis-pid-tof-full", "o2-analysis-pid-tof-beta", "o2-analysis-pid-tpc-base", "o2-analysis-track-to-collision-associator"]
...
if extrargs.add_timestamp:
    commandToRun += " | o2-analysis-timestamp --configuration json://" + updatedConfigFileName + " -b"

if extrargs.add_trackselec:
    commandToRun += " | o2-analysis-trackselection --configuration json://" + updatedConfigFileName + " -b"
